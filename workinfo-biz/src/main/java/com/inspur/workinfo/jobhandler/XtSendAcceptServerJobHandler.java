...
@JobHandler(value = "xtSendAcceptServerJobHandler")
@Component
@Slf4j
public class XtSendAcceptServerJobHandler extends IJobHandler {
    private Logger logger  = LoggerFactory.getLogger(XtSendAcceptServerJobHandler.class);
    ...
    public ReturnT<String> execute(String s) throws Exception {
        ...
        XxlJobLogger.log("【推送消息XtSendAcceptServerTask】开始执行：{}", DateUtil.formatDateTime(new Date()));
