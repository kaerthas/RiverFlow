 ...
 * **********/
@JobHandler(value = "xtSendNeedCorrectionServeJobHandler")
@Component
@Slf4j
public class XtSendNeedCorrectionServeJobHandler extends IJobHandler {

    private Logger logger = LoggerFactory.getLogger(XtSendNeedCorrectionServeJobHandler.class);
