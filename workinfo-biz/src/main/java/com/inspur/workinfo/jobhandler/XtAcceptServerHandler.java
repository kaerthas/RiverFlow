...
import com.inspur.workinfo.task.XtAcceptServerTask;
...
@JobHandler(value = "xtAcceptServerHandler")
@Component
@Slf4j
public class XtAcceptServerHandler extends IJobHandler {

    private Logger logger  = LoggerFactory.getLogger(XtAcceptServerHandler.class);
    ...
    public ReturnT<String> execute(String param) throws Exception {
        ...
        boolean isok = false;
        XxlJobLogger.log("【推送消息XtAcceptServerTask】开始执行：{}", DateUtil.formatDateTime(new Date()));
        ...
        XxlJobLogger.log("【推送消息XtAcceptServerTask】执行结束：{}", DateUtil.formatDateTime(new Date()));
