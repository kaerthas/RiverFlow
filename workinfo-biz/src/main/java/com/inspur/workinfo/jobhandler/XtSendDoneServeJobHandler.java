...
import com.inspur.workinfo.task.XtSendDoneServeTask;
 ...
 * SendDone 标准字段
 * *******/
@JobHandler(value = "xtSendDoneServeJobHandler")
@Component
@Slf4j
public class XtSendDoneServeJobHandler  extends IJobHandler {
    private final Logger logger  = LoggerFactory.getLogger(XtSendDoneServeJobHandler.class);
    @Autowired
    ...
    public ReturnT<String> execute(String s) throws Exception {
        ...
        XxlJobLogger.log("【推送消息XtSendDoneServeTask】开始执行：{}", DateUtil.formatDateTime(new Date()));
        ...
        XxlJobLogger.log("【推送消息XtSendDoneServeTask】结束执行：{}", DateUtil.formatDateTime(new Date()));
