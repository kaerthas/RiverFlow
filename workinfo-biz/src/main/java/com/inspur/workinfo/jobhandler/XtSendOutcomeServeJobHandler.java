...
@JobHandler(value = "XtSendOutcomeServeJobHandler")
@Component
@Slf4j
public class XtSendOutcomeServeJobHandler extends IJobHandler {

    private Logger logger = LoggerFactory.getLogger(XtSendOutcomeServeJobHandler.class);
    ...
    public ReturnT<String> execute(String s) throws Exception {
        ...
        XxlJobLogger.log("【推送消息XtSendOutcomeServeTask】开始执行：{}", DateUtil.formatDateTime(new Date()));
        ...
        XxlJobLogger.log("【推送消息XtSendOutcomeServeTask】结束执行：{}", DateUtil.formatDateTime(new Date()));
        if(isflag){
            return SUCCESS;
        }else{
            return FAIL;
