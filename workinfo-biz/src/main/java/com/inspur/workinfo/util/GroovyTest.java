...
//        script.invokeMethod("HelloWorld", null);
        ...
        Script script = groovyShell.parse("package groovy\n" +
                ...
                "import groovy.xml.XmlUtil\n"+
                        ...
                        "def add(String json) {\n" +
                            "def res_data  = JSONObject.parseObject(json)\n"+
...
//                        "}");
        ...
        String sum = (String ) script.invokeMethod("add", "{\"code\":200,\"data\":\"{\\\"data\\\":\\\"<?xml version=\\\\\\\"1.0\\\\\\\" encoding=\\\\\\\"UTF-8\\\\\\\" standalone=\\\\\\\"no\\\\\\\"?>\\\\n<Result>\\\\n  <Status>200</Status>\\\\n  <Desc>请求成功</Desc>\\\\n  <Time>2023-09-11 16:03:05 531</Time>\\\\n  <Data/>\\\\n</Result>\\\\n\\\\n\\\"}\",\"message\":\"\"}\n");
