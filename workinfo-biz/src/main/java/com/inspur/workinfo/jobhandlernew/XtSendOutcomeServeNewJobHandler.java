...
@JobHandler(value = "xtSendOutcomeServeNewJobHandler")
@Component
@Slf4j
public class XtSendOutcomeServeNewJobHandler extends IJobHandler {

    private Logger logger = LoggerFactory.getLogger(XtSendOutcomeServeNewJobHandler.class);
