...
@Component
@Slf4j
public class XtGetOutcomeServeTask {
...
//    @Scheduled(cron = "0 */1 * * * ? ")
    public void websocket() throws Exception {
        log.info("【推送消息XtGetOutcomeServeTask】开始执行：{}", DateUtil.formatDateTime(new Date()));
        ...
        log.info("【推送消息XtGetOutcomeServeTask】结束执行：{}", DateUtil.formatDateTime(new Date()));
