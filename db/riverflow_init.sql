...
CREATE TABLE IF NOT EXISTS wf_api_catalog (
    ...
    trigger_enabled TINYINT DEFAULT 0 COMMENT '是否启用流程触发：0-否 1-是',
    trigger_flow_id BIGINT DEFAULT NULL COMMENT '执行成功后触发的流程定义ID',
    trigger_biz_key_field VARCHAR(64) DEFAULT NULL COMMENT '从请求参数中提取业务主键的字段名',
