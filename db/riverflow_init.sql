...
CREATE TABLE `wf_flow_definition`  (
  ...
  `status` tinyint(4) NULL DEFAULT 0 COMMENT '状态：0-草稿 1-已发布 2-下线',
  `execution_mode` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT 'ASYNC' COMMENT '执行模式：ASYNC-异步(默认) SYNC-同步',
  `input_params` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '同步流程默认入参(JSON)',
  `output_params` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '同步流程输出参数(JSON)',
